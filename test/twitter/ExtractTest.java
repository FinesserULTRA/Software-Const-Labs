...
public class ExtractTest {
	...
	@Test
	public void testGetTimespanSingle() {
		Timespan span = Extract.getTimespan(Collections.singletonList(tweet1));
		assertEquals(d1, span.getStart());
		assertEquals(d1, span.getEnd());
	}

	@Test
	public void testGetTimespanMultipleMinToMax() {
		Timespan span = Extract.getTimespan(Arrays.asList(tweet1, tweet2));
		assertEquals(d1, span.getStart());
		assertEquals(d2, span.getEnd());
	}

	@Test
	public void testGetTimespanUnorderedInput() {
		Timespan span = Extract.getTimespan(Arrays.asList(tweet1, tweet2));
		assertEquals(d1, span.getStart());
		assertEquals(d2, span.getEnd());
	}
	...
	public void testGetMentionedUsersNoMentions() {
		Set<String> users = Extract.getMentionedUsers(Arrays.asList(tweet2));
